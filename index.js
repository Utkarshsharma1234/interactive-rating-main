...
one.addEventListener("click", function () {
  if (a == 2 || a == 3 || a == 4 || a == 5) {
    one.style.backgroundColor = "#FF760E";
    one.style.color = "white";
    a = one.innerText;
    two.style.backgroundColor = "#262F38";
    two.style.color = "#7E868F";
    three.style.backgroundColor = "#262F38";
    three.style.color = "#7E868F";
    four.style.backgroundColor = "#262F38";
    four.style.color = "#7E868F";
    five.style.backgroundColor = "#262F38";
    five.style.color = "#7E868F";
    return a;
  } else {
    one.style.backgroundColor = "#FF760E";
    one.style.color = "white";
...
two.addEventListener("click", function () {
  if (a == 1 || a == 3 || a == 4 || a == 5) {
    two.style.backgroundColor = "#FF760E";
    two.style.color = "white";
    a = two.innerText;
    one.style.backgroundColor = "#262F38";
    one.style.color = "#7E868F";
    three.style.backgroundColor = "#262F38";
    three.style.color = "#7E868F";
    four.style.backgroundColor = "#262F38";
    four.style.color = "#7E868F";
...
three.addEventListener("click", function () {
  if (a == 1 || a == 2 || a == 4 || a == 5) {
    three.style.backgroundColor = "#FF760E";
...
four.addEventListener("click", function () {
  if (a == 1 || a == 3 || a == 2 || a == 5) {
    four.style.backgroundColor = "#FF760E";
...
five.addEventListener("click", function () {
  if (a == 1 || a == 3 || a == 4 || a == 2) {
    five.style.backgroundColor = "#FF760E";
